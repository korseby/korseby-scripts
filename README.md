...
- development is being done on <a href="https://github.com/korseby/py3tag">github.com/korseby/py3tag</a>

### spleet_voice.sh
- grabs the audio track of a video file, extracts the voice using the tool <a href="https://github.com/deezer/spleeter">spleeter</a> and adds the voice-only track to the video again
- <a href="https://github.com/deezer/spleeter">github.com/deezer/spleeter</a> v1.4.0 (first public release)
